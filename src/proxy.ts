...
function addSecurityHeaders(response: NextResponse): NextResponse {
  ...
  h.set(
    ...
    [
      ...
      "img-src 'self' data: blob: https://images.pexels.com https://cf.bstatic.com https://q-xx.bstatic.com https://*.supabase.co https://*.tile.openstreetmap.org https://unpkg.com",
      "connect-src 'self' https://*.supabase.co wss://*.supabase.co https://api.mapbox.com https://tiles.openfreemap.org https://*.maptiler.com https://*.tile.openstreetmap.org",
      "worker-src blob:",
      "child-src blob:",
