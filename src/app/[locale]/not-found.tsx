      ...
      <div className="text-center px-4 max-w-lg">
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-3">
          ...
          <Link
            ...
            className="flex items-center justify-center gap-2 border border-stone-200 text-stone-700 hover:border-amber-400 hover:text-amber-600 font-semibold px-6 py-3 rounded-xl transition-colors"
          >
