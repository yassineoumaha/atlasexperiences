  ...
  return (
    <div className="pt-20 min-h-screen bg-card">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 py-12">
        ...
        <p className="text-muted-foreground text-sm mb-8">Last updated: {LAST_UPDATED} · Effective: {LAST_UPDATED}</p>
        ...
        <div className="prose prose-stone max-w-none space-y-8 text-sm leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-black text-foreground mb-3">1. Data Controller</h2>
            ...
            <p className="mt-2">Contact: <a href="mailto:privacy@imourig.com" className="text-primary underline">privacy@imourig.com</a></p>
          </section>

          <section>
            <h2 className="text-xl font-black text-foreground mb-3">2. What Data We Collect & Why</h2>
            <table className="w-full text-xs border-collapse">
              <thead>
                <tr className="bg-muted/40">
                  <th className="text-left p-2 border border-border">Data</th>
                  <th className="text-left p-2 border border-border">Why We Collect It</th>
                  <th className="text-left p-2 border border-border">Legal Basis</th>
                </tr>
              </thead>
              <tbody>
                {[
                  ...
                  <tr key={data}>
                    <td className="p-2 border border-border font-medium">{data}</td>
                    <td className="p-2 border border-border">{why}</td>
                    <td className="p-2 border border-border text-muted-foreground">{basis}</td>
                  </tr>
                ))}
              </tbody>
            </table>
          ...
          <section>
            <h2 className="text-xl font-black text-foreground mb-3">3. How We Share Your Data</h2>
          ...
          <section>
            <h2 className="text-xl font-black text-foreground mb-3">4. Cookies (Law 09-08 + GDPR)</h2>
          ...
          <section>
            ...
            <p className="mt-3">To exercise any right: <a href="mailto:privacy@imourig.com" className="text-primary underline">privacy@imourig.com</a>. We respond within <strong>30 days</strong> (Law 09-08) / <strong>1 month</strong> (GDPR).</p>
