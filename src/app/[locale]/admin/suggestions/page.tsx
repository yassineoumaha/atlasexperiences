  ...
  return (
    <div>
      <div className="flex items-center gap-3 mb-8">
        ...
        <h1 className="text-2xl font-black text-stone-900">Suggestions</h1>
        ...
        <table className="w-full text-sm">
          <thead className="bg-stone-50 border-b border-stone-100">
            <tr>
              ...
              <th className="text-left px-4 py-3 font-semibold text-stone-600">Message</th>
              <th className="text-left px-4 py-3 font-semibold text-stone-600">From</th>
          ...
          <tbody className="divide-y divide-stone-50">
            {(suggestions ?? []).map((s: any) => (
              <tr key={s.id} className="hover:bg-stone-50">
                ...
                <td className="px-4 py-3 text-stone-700 max-w-sm">
