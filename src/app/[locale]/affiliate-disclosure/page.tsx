  ...
  return (
    <div className="pt-20 min-h-screen bg-white">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 py-12">
        <h1 className="text-3xl font-black text-stone-900 mb-2">Affiliate Disclosure</h1>
        ...
        <div className="prose prose-stone max-w-none space-y-8 text-sm leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-black text-stone-900 mb-3">4. Editorial Independence</h2>
          ...
          <div className="pt-4 border-t border-stone-100 flex flex-wrap gap-4 text-sm">
            <Link href="/en/terms" className="text-amber-600 hover:text-amber-700 underline">Terms & Conditions</Link>
            <Link href="/en/privacy" className="text-amber-600 hover:text-amber-700 underline">Privacy Policy</Link>
          </div>
        </div>
      </div>
    </div>
